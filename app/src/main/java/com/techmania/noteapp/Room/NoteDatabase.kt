...
abstract class NoteDatabase : RoomDatabase(){
    ...
    companion object{
        ...
        fun getDatabse(contex : Context, scope : CoroutineScope) : NoteDatabase{
            return INSTANCE ?: synchronized(this){

                val instance = Room.databaseBuilder(contex.applicationContext,NoteDatabase::class.java,"note_database")
